...
import org.shovelgame.domain.aspect.CommonFieldsAspect.PublishedFieldDeclaration;
...
public abstract class DialsController<T extends Entity> extends NestingEntityRestfulCRUDController<T> {
	...
	@Resource(name="dialsMenu")
	private MenuFactory mFactory;

	@ModelAttribute("dialsMenu")
