...
--AI test
--test skill
insert into model.skill (id, alg, attribute_type, icon_name, power, cooldown, ticks, type, skillId) values (nextval('model.skill_id_seq'), 'Damage', 'Health', 'skill1', 5, 0, 0, 'PhysicalPower', 'testSkill');
...
insert into model.trait (id, type, affected_attribute_type, alg, power, icon_name) values (nextval('model.trait_id_seq'), 'Percentage', 'Mana', 'Increase', 10, 'health');
...
insert into model.trait (id, type, affected_attribute_type, alg, power, icon_name) values (nextval('model.trait_id_seq'), 'Percentage', 'Health', 'Decrease', 10, 'health');
...
insert into model.minion_attribute (id, minion_model, type, value) values (nextval('model.minion_attribute_id_seq'), currval('model.minion_model_id_seq'), 'Health', 150);
insert into model.trait (id, type, affected_attribute_type, alg, power, icon_name) values (nextval('model.trait_id_seq'), 'Percentage', 'SpellPower', 'Decrease', 4, 'health');
insert into model.trait_target (id, trait, position) values (nextval('model.trait_target_id_seq'), currval('model.trait_id_seq'), 'Leader');
insert into model.trait_target (id, trait, position) values (nextval('model.trait_target_id_seq'), currval('model.trait_id_seq'), 'Bot');
insert into model.trait_target (id, trait, position) values (nextval('model.trait_target_id_seq'), currval('model.trait_id_seq'), 'Top');
insert into model.trait_target (id, trait, position) values (nextval('model.trait_target_id_seq'), currval('model.trait_id_seq'), 'Mid');
...
insert into model.trait (id, type, affected_attribute_type, alg, power, icon_name) values (nextval('model.trait_id_seq'), 'Percentage', 'Health', 'Increase', 5, 'health');
insert into model.trait_target (id, trait, position) values (nextval('model.trait_target_id_seq'), currval('model.trait_id_seq'), 'Leader');
insert into model.trait_target (id, trait, position) values (nextval('model.trait_target_id_seq'), currval('model.trait_id_seq'), 'Bot');
insert into model.minion_trait (minion_model, trait, required_level) values (currval('model.minion_model_id_seq'), currval('model.trait_id_seq'), 1);
insert into data.minion (id, minion_model, level) values (nextval('data.minion_id_seq'), currval('model.minion_model_id_seq'), 30);
...
insert into model.trait (id, type, affected_attribute_type, alg, power, icon_name) values (nextval('model.trait_id_seq'), 'Addition', 'SpellPower', 'Increase', 10, 'health');
insert into model.minion_trait (minion_model, trait, required_level) values (currval('model.minion_model_id_seq'), currval('model.trait_id_seq'), 1);
insert into data.minion (id, minion_model, level) values (nextval('data.minion_id_seq'), currval('model.minion_model_id_seq'), 20);
insert into model.minion_skill (minion_model, skill, required_level) values (currval('model.minion_model_id_seq'), currval('model.skill_id_seq'), 1);
...
insert into model.minion_model (id, name, specialization, image_bundle_name, rarity) values (nextval('model.minion_model_id_seq'), 'DamageBot1', 'Damage', 'Zola', 'Common');
insert into model.minion_attribute (id, minion_model, type, value) values (nextval('model.minion_attribute_id_seq'), currval('model.minion_model_id_seq'), 'Health', 150);
insert into model.trait (id, type, affected_attribute_type, alg, power, icon_name) values (nextval('model.trait_id_seq'), 'Percentage', 'Health', 'Decrease', 2, 'health');
insert into model.trait_target (id, trait, position) values (nextval('model.trait_target_id_seq'), currval('model.trait_id_seq'), 'Leader');
insert into model.trait_target (id, trait, position) values (nextval('model.trait_target_id_seq'), currval('model.trait_id_seq'), 'Mid');
insert into model.minion_trait (minion_model, trait, required_level) values (currval('model.minion_model_id_seq'), currval('model.trait_id_seq'), 1);
insert into data.minion (id, minion_model, level) values (nextval('data.minion_id_seq'), currval('model.minion_model_id_seq'), 1);
...
insert into model.trait (id, type, affected_attribute_type, alg, power, icon_name) values (nextval('model.trait_id_seq'), 'Percentage', 'PhysicalPower', 'Decrease', 5, 'health');
insert into model.trait_target (id, trait, position) values (nextval('model.trait_target_id_seq'), currval('model.trait_id_seq'), 'Bot');
insert into model.trait_target (id, trait, position) values (nextval('model.trait_target_id_seq'), currval('model.trait_id_seq'), 'Top');
insert into model.minion_trait (minion_model, trait, required_level) values (currval('model.minion_model_id_seq'), currval('model.trait_id_seq'), 1);
insert into data.minion (id, minion_model, level) values (nextval('data.minion_id_seq'), currval('model.minion_model_id_seq'), 30);
...
insert into model.trait (id, type, affected_attribute_type, alg, power, icon_name) values (nextval('model.trait_id_seq'), 'Percentage', 'Health', 'Increase', 10, 'health');
insert into model.trait_target (id, trait, position) values (nextval('model.trait_target_id_seq'), currval('model.trait_id_seq'), 'Top');
insert into model.trait_target (id, trait, position) values (nextval('model.trait_target_id_seq'), currval('model.trait_id_seq'), 'Mid');
insert into model.minion_trait (minion_model, trait, required_level) values (currval('model.minion_model_id_seq'), currval('model.trait_id_seq'), 1);
insert into data.minion (id, minion_model, level) values (nextval('data.minion_id_seq'), currval('model.minion_model_id_seq'), 30);
