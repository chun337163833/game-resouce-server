...
privileged aspect Customer_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Customer.fieldNames4OrderClauseFilter = java.util.Arrays.asList("serialVersionUID", "title", "address", "birthDate", "blackListed", "basicDiscountPaidDate", "tariff", "company", "ratings");
