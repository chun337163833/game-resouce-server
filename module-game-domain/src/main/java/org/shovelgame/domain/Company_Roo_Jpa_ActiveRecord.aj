...
privileged aspect Company_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Company.fieldNames4OrderClauseFilter = java.util.Arrays.asList("id", "companyName", "companyRepresentative", "address", "country", "phone", "email", "ic", "dic");
