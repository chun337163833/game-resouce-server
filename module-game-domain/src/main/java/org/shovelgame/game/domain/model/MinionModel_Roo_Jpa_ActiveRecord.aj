...
privileged aspect MinionModel_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> MinionModel.fieldNames4OrderClauseFilter = java.util.Arrays.asList("minionAttributes", "minionSkills", "minionTraits", "specialization", "name", "imageBundleName", "price");
